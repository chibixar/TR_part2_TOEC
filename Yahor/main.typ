...
#show: gost.with(
  ...
  performer: (
    name: "Иванов И.И.", // Замените на ваши ФИО
    group: "558301",
  ),
...
#lab-figure(
  ...
  [
    ...
    #circuit-better(scale-factor: 70%, {
      ...
      node-better("1", (8, 0), label: (content: "1", anchor: "south-west", distance: 0.5), visible: true)
      node-better("5", (8, 12), label: (content: "5", anchor: "north-west", distance: 0.5), visible: true)
      node-better("2", (0, 0), label: (content: "2", anchor: "south-east", distance: 0.5), visible: true)
      node-better("4", (0, 12), label: (content: "4", anchor: "north-east", distance: 0.5), visible: true)
      node-better("6", (16, 12), label: (content: "6", anchor: "north-west", distance: 0.5), visible: true)
      node-better("3", (16, 0), label: (content: "3", anchor: "south-west", distance: 0.5), visible: true)

      // Ветвь 5 (1 -> 2)
      source-better("E5", "1", (5,0), label: (content: $E_5$, anchor: "south", distance: 1.0), arrow-dir: "forward")
      inductor-better("L5", (5,0), (2.5,0), label: (content: $L_5$, anchor: "south", distance: 0.8))
      capacitor-better("C5", (2.5,0), "2", label: (content: $C_5$, anchor: "south", distance: 0.8), arrow-label: (content: $I_5$, anchor: "north", distance: 0.8), arrow-side: "north", arrow-dir: "forward")

      // Ветвь 6 (2 -> 4)
      resistor-better("R6", "2", (0,6), label: (content: $R_6$, anchor: "east", distance: 0.8), arrow-label: (content: $I_6$, anchor: "west", distance: 0.8), arrow-side: "west")
      inductor-better("L6", (0,6), "4", label: (content: $L_6$, anchor: "east", distance: 0.8))

      // Ветвь 1 (4 -> 5)
      resistor-better("R1", "4", "5", label: (content: $R_1$, anchor: "south", distance: 0.8), arrow-label: (content: $I_1$, anchor: "north", distance: 0.8), arrow-side: "north")

      // Ветвь 7 (5 -> 1)
      resistor-better("R7", "5", (8,6), label: (content: $R_7$, anchor: "east", distance: 0.8), arrow-label: (content: $I_7$, anchor: "west", distance: 0.8), arrow-side: "west")
      capacitor-better("C7", (8,6), "1", label: (content: $C_7$, anchor: "east", distance: 0.8))

      // Ветвь 2 (5 -> 6)
      inductor-better("L2", "5", (12,12), label: (content: $L_2$, anchor: "south", distance: 0.8), arrow-label: (content: $I_2$, anchor: "north", distance: 0.8), arrow-side: "north")
      capacitor-better("C2", (12,12), "6", label: (content: $C_2$, anchor: "south", distance: 0.8))

      // Источник тока J2 параллельно ветви 2
      wire("5", (8,15))
      jsource-better("J2", (8,15), (16,15), label: (content: $J_2$, anchor: "north", distance: 1.0), arrow-dir: "forward")
      wire((16,15), "6")

      // Ветвь 3 (6 -> 3)
      inductor-better("L3", "6", "3", label: (content: $L_3$, anchor: "west", distance: 0.8), arrow-label: (content: $I_3$, anchor: "east", distance: 0.8), arrow-side: "east")

      // Ветвь 4 (3 -> 1)
      resistor-better("R4", "3", (12,0), label: (content: $R_4$, anchor: "south", distance: 0.8), arrow-label: (content: $I_4$, anchor: "north", distance: 0.8), arrow-side: "north")
      capacitor-better("C4", (12,0), "1", label: (content: $C_4$, anchor: "south", distance: 0.8))
    })
    #v(-0.5cm)
  ]
)
...
#lab-figure(
  ...
  [
    ...
    #circuit-better(scale-factor: 85%, {
      import zap: *
      node-better("1", (0, 0), label: (content: "1", anchor: "north", distance: 0.5), visible: true)
      node-better("5", (0, 8), label: (content: "5", anchor: "south", distance: 0.5), visible: true)
      
      // Ветвь A (слева)
      wire("1", (-4, 0))
      source-better("EA", (-4, 0), (-4, 3), label: (content: $E_A$, anchor: "east", distance: 0.8), arrow-dir: "forward")
      resistor-better("ZA", (-4, 3), (-4, 8), label: (content: $Z_A$, anchor: "east", distance: 0.8), arrow-label: (content: $I_A$, anchor: "west", distance: 0.8), arrow-side: "west", arrow-offset: 0.4)
      wire((-4, 8), "5")

      // Ветвь C (по центру)
      resistor-better("ZC", "5", "1", label: (content: $Z_C$, anchor: "east", distance: 0.8), arrow-label: (content: $I_C$, anchor: "west", distance: 0.8), arrow-side: "west", arrow-offset: 0.4)

      // Ветвь B (справа)
      wire("5", (4, 8))
      source-better("EB", (4, 8), (4, 5), label: (content: $E_B$, anchor: "west", distance: 0.8), arrow-dir: "forward")
      resistor-better("ZB", (4, 5), (4, 0), label: (content: $Z_B$, anchor: "west", distance: 0.8), arrow-label: (content: $I_B$, anchor: "east", distance: 0.8), arrow-side: "east", arrow-offset: 0.4)
      wire((4, 0), "1")
    })
    #v(-0.6cm)
  ]
...
#lab-figure(
  ...
  [
    ...
    #circuit-better(scale-factor: 85%, {
      ...
      wire("1", (-4, 0))
      source-better("EA", (-4, 0), (-4, 3), label: (content: $E_A$, anchor: "east", distance: 0.8), arrow-dir: "forward")
      resistor-better("ZA", (-4, 3), (-4, 8), label: (content: $Z_A$, anchor: "east", distance: 0.8), arrow-label: (content: $I_"A,xx"$, anchor: "west", distance: 0.8), arrow-side: "west", arrow-offset: 0.4)
      wire((-4, 8), "5")

      // Разрыв вместо ветви C
      open-branch-better("Uxx", "5", "1", label: (content: $dot(U)_"хх"$, anchor: "east", distance: 0.5), arrow-side: "east", arrow-dir: "forward", show-terminals: true, arrow-offset: 0.4)

      // Ветвь B (справа)
      wire("5", (4, 8))
      source-better("EB", (4, 8), (4, 5), label: (content: $E_B$, anchor: "west", distance: 0.8), arrow-dir: "forward")
      resistor-better("ZB", (4, 5), (4, 0), label: (content: $Z_B$, anchor: "west", distance: 0.8), arrow-label: (content: $I_"B,xx"$, anchor: "east", distance: 0.8), arrow-side: "east", arrow-offset: 0.4)
      wire((4, 0), "1")
    })
    #v(-0.6cm)
  ]
...
#lab-figure(
  ...
  [
    ...
    #circuit-better(scale-factor: 85%, {
      import zap: *
      node-better("5", (0, 6), label: (content: "5", anchor: "south", distance: 0.5), visible: true)
      node-better("1", (0, 0), label: (content: "1", anchor: "north", distance: 0.5), visible: true)
      
      wire("5", (-4, 6))
      source-better("Eeq", (-4, 6), (-4, 3), label: (content: $dot(U)_"хх"$, anchor: "east", distance: 1.2), arrow-dir: "forward")
      resistor-better("Zeq", (-4, 3), (-4, 0), label: (content: $Z_"экв"$, anchor: "east", distance: 0.5))
      wire((-4, 0), "1")

      resistor-better("R7", "5", (0,3), label: (content: $R_7$, anchor: "west", distance: 0.5), arrow-label: (content: $I_7$, anchor: "east", distance: 0.5), arrow-side: "east", arrow-offset: 0.4)
      capacitor-better("C7", (0,3), "1", label: (content: $C_7$, anchor: "west", distance: 0.5))
    })
    #v(-0.4cm)
  ]
)
...
#figure(
  ...
  table(
    ...
    [$I_1=I_5=I_6$], [0.232], [-0.015], [0.232], [-3.70],
    [$I_2$], [-0.902], [0.349], [0.967], [158.83],
    [$I_3=I_4$], [0.054], [0.057], [0.079], [46.55],
